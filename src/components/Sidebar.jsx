...
export function PlayerSidebar({ name, hp, maxHp, note, anim, tick }) {
    return (
        <aside className="app-sidebar">
            <div className="sidebar-panel">
                <div className="sidebar-character-frame">
                    <PlayerCharacter animKey={tick ?? 0} anim={anim ?? 'idle'} />
                </div>
...
export function EnemySidebar({ name, hp, maxHp, note, anim, tick, variant }) {
    return (
        <aside className="app-sidebar right">
            <div className="sidebar-panel">
                <div className="sidebar-character-frame">
                    <EnemyCharacter animKey={tick ?? 0} anim={anim ?? 'idle'} variant={variant ?? 'orc'} />
                </div>
